...
$buscar_cadastro = "SELECT * FROM tb_aluno ";
  ...
  <table class="table">
	  ...
	  <tbody>
	         ...
	         While($receber_cadastros = mysqli_fetch_array($query_cadastro))
		 {
			...
			$ano_nasc = $receber_cadastros['dataNascimento'];
			$curso = $receber_cadastros['curso'];
		  ...
		  <tr>
			...
			<td>            <input type="text" name="dataNascimento" value="<?php echo $ano_nasc; ?>"></td>
